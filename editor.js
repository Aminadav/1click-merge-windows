	...
	$('#topText').html
		...
		// Ready for action
		 ...
		 xhr.setRequestHeader('Authorization', 'OAuth ' + googleAuth.getAccessToken())
			...
			"mimeType": "image/png",
			"description": 'Taken by 1Click Screenshot. https://www.openscreenshot.com'
			};
